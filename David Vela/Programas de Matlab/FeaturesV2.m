...
%EL 18-05-2021. Cambio de una Fs fija a una introducida a la función,
%colocar en el comentario de "op" del orden de los parámetros en la
%"Matriz_features", implementar el filtrado Butterworth con la función
%"butter" y remover el filtrado de la frecuencia eléctrica.
...
Fchp = 0.5;
    ...
    W_bhp = Fchp/(fs/2); % Normalización de la frecuencia de corte pasa bajas
